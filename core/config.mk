...
ifneq ($(BLACKIRON_BUILD),)
include vendor/blackiron/config/BoardConfigBlackiron.mk
endif
...
ifneq ($(BLACKIRON_BUILD),)
ifneq ($(wildcard device/blackiron/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/blackiron/sepolicy/common/sepolicy.mk)
endif
